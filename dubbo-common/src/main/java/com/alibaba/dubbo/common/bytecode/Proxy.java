...
public abstract class Proxy {
    ...
    public static Proxy getProxy(ClassLoader cl, Class<?>... ics) {
        ...
        String pkg = null;
        ClassGenerator ccp = null; // 用于为服务接口生成代理类，比如我们有一个 DemoService 接口，这个接口代理类就是由 ccp 生成的
        ClassGenerator ccm = null; // 用于为 org.apache.dubbo.common.bytecode.Proxy 抽象类生成子类，主要是实现 Proxy 类的抽象方法
        try {
